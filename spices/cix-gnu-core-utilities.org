...
# Last Modified : <2016-11-24 Thu 23:44:58 GMT> sharlatan
...
- dd-161124225351 :: killing fiartures of *dd* (*,..,*): distruc damage erase
  :    ~ # dd if=/dev/zero of=/dev/sdX    #  format device
  :    ~ # dd if=/dev/random of=/dev/port #  freez the system
...
- dd-161115233028 :: dublicte several drives cuncurrently: copy clone backup
  #+BEGIN_SRC sh
    #!/usr/bin/env bash
