...
# Modified   : <2020-12-01 Tue 22:28:53 GMT>
# Maintainer : sharlatan
# Synopsis   : <A set of basic GNU tools commonly used in shell scripts>
...
without stopping should an error be encountered (such as bad blocks),
and replacing any errors found with null bytes.
...
*** tail::examples
**** tail-201201213814
delete all files except the newest N=4:
:    ~$ ls -t <some-pattern> | tail -n +${N} | xargs -I {} rm {}
:    ~$ ls -At <some-pattern> | tail -n +${N} | xargs -I {} rm {}

**** tail-201201214038
list all files except the newest N=4:
:    ~$ ls -t | tail -n +4
:    ~$ ls -At | tail -n +4
:    ~$ ls -t <some-pattern> | tail -n +${N}
:    ~$ ls -At <some-pattern> | tail -n +${N}
ls
xargs
*** tail::files
*** tail::see-also
