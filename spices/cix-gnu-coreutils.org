...
# Modified   : <2018-8-20 Mon 21:01:20 BST> Sharlatan
...
:    ~$ cut -c-N input_f                        # trim from left by N
:    ~$ rev input_f | cut -c-N | rev            # trim from rigth by N
:    ~$ cut -c-N input_f | rev | cut -c-N | rev # trim from both sides by N
