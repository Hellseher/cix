...
# Modified   : <2017-9-02 Sat 00:33:16 BST> sharlatan
...
- *Networking* /we all live in the someone's subnet in/
  ...
  + [[./spices/cix-net-snmp.org][net-snmp]] :: a collection of snmp protocol tools and libraries: =GNU/Linux= =FreeBSD= =OpenBSD= =Solaris= =OS-X=
...
- *Development* /in the fields of observation chance favors only the prepared mind./
  ...
  + [[file:./spaces/cix-gnu-bison.org][bison]] :: 
